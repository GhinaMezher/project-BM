...
```{r}
dep_chomage_africa_filtered <- dep_chomage_afr %>%
  filter(time >= 2010 & time <= 2022, Country %in% c("MDG", "MLI", "NER", "MWI","RWA", "SSD", "ZMB","DJI","AFE", "BDI", "BFA", "BLZ", "CAF", "COD", "LBR", "SDN", "SEN", "DAZ", "BWA", "TCD", "EGY", "ERI", "ETH", "GMB", "KEN", "LBY", "MAR", "NAM", "NGA", "SLE", "ZAF", "TGO", "TUN", "YEM", "ZWE"))
...
matrix_africa <- matrix(c(correlation_afr$estimate, correlation_afr$p.value), nrow = 1, dimnames = list(NULL, c("Correlation Coefficient", "P-Value")))
